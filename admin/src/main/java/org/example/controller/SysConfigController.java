...
import org.example.system.domain.SysConfig;
...
public class SysConfigController extends BaseController {
     ...
     * 获取参数配置列表
     */
    @org.example.system.security.annotation.RequiresPermissions("system:config:list")
    @GetMapping("/list")
    ...
    public AjaxResult add(@Validated @RequestBody SysConfig config) {
        ...
        config.setCreateBy(org.example.system.security.utils.SecurityUtils.getUsername());
