...
import org.example.system.domain.SysUserRole;
...
public class SysRoleController extends BaseController {
    ...
    @org.example.system.security.annotation.RequiresPermissions("system:role:list")
    @GetMapping("/list")
    ...
    @org.example.system.security.annotation.RequiresPermissions("system:role:export")
    @PostMapping("/export")
     ...
     * 根据角色编号获取详细信息
     */
    @org.example.system.security.annotation.RequiresPermissions("system:role:query")
     ...
     * 新增角色
     */
    @org.example.system.security.annotation.RequiresPermissions("system:role:add")
    ...
    public AjaxResult add(@Validated @RequestBody SysRole role) {
        ...
        role.setCreateBy(org.example.system.security.utils.SecurityUtils.getUsername());
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role) {
        ...
        role.setUpdateBy(org.example.system.security.utils.SecurityUtils.getUsername());
     ...
     * 修改保存数据权限
     */
    @org.example.system.security.annotation.RequiresPermissions("system:role:edit")
    @Log(title = "角色管理", businessType = BusinessType.UPDATE)
