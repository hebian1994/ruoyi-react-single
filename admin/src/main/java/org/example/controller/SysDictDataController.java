...
import org.example.system.domain.SysDictData;
import org.example.system.log.annotation.Log;
import org.example.system.log.enums.BusinessType;
import org.example.system.service.SysDictDataService;
...
public class SysDictDataController extends BaseController {
    ...
    @org.example.system.security.annotation.RequiresPermissions("system:dict:list")
    @GetMapping("/list")
    ...
    public AjaxResult add(@Validated @RequestBody SysDictData dict) {
        dict.setCreateBy(org.example.system.security.utils.SecurityUtils.getUsername());
