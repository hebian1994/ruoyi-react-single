...
import static org.example.common.core.web.domain.AjaxResult.success;
...
public class SysDeptController extends BaseController {
     ...
     * 获取部门列表
     */
    @org.example.system.security.annotation.RequiresPermissions("system:dept:list")
    @GetMapping("/list")
    ...
    public AjaxResult add(@Validated @RequestBody SysDept dept) {
        ...
        dept.setCreateBy(org.example.system.security.utils.SecurityUtils.getUsername());
